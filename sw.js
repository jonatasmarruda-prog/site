const CACHE='trilheiros-gps-v10.0.0';
const ASSETS=['./','index.html','app.css?v=10','app.js?v=10','v10.js?v=10','logo-data.js?v=10','manifest.webmanifest?v=10','assets/icons/icon-192.png','assets/icons/icon-512.png','assets/icons/apple-touch-icon.png'];
