const CACHE='trilheiros-gps-v1.0.0';
const ASSETS=['./','index.html','app.css','app.js','manifest.webmanifest','assets/logo-trilheiros.png','assets/icons/icon-192.png','assets/icons/icon-512.png','assets/icons/apple-touch-icon.png'];
